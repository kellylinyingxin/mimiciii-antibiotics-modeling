...
```{r}
worst2<- read.csv('/Users/geickelb1/Documents/GitHub/mimiciii-antibiotics-modeling/data/processed/merged/04042019_worstdf_preImp.csv',stringsAsFactors=TRUE, check.names=FALSE)
...
```{r}
write.csv(trainSet, file ="/Users/geickelb1/Documents/GitHub/mimiciii-antibiotics-modeling/models/imputation/01042019_train.csv", row.names=FALSE)
write.csv(testSet, file ="/Users/geickelb1/Documents/GitHub/mimiciii-antibiotics-modeling/models/imputation/01042019_test.csv", row.names=FALSE)
```
