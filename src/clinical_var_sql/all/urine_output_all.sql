-- ------------------------------------------------------------------
-- Purpose: Create a view of the urine output for each ICUSTAY_ID over each 24 hour peroid.
-- ------------------------------------------------------------------

DROP MATERIALIZED VIEW IF EXISTS urine_output_all CASCADE;
create materialized view urine_output_all as
select
  -- patient identifiers
